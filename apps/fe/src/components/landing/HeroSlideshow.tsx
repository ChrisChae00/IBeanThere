    ...
    <div className="relative min-h-[calc(100vh-4rem)] overflow-hidden">
      ...
      <div className="relative max-w-8xl mx-auto px-4 sm:px-6 lg:px-8 h-full flex flex-col items-start pt-[30%] sm:pt-[25%] md:pt-[20%] lg:pt-[20%]">
        <div className="max-w-3xl lg:max-w-4xl xl:max-w-5xl space-y-4 sm:space-y-6 motion-slide-up">
          <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-textHero leading-tight drop-shadow-lg break-keep">
            {t.rich('title', { mobileBr: () => <br className="block" /> })}
          </h1>
          <p className="text-base sm:text-lg md:text-xl lg:text-2xl text-textHero leading-relaxed drop-shadow-sm break-keep max-w-2xl lg:max-w-4xl">
            {t.rich('subtitle', {
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <a
              ...
              className="px-6 py-3 rounded-full border-2 border-textHero text-textHero bg-white/5 hover:bg-primary hover:text-primaryText transition-all min-h-[48px] flex items-center justify-center text-center shadow-[0_10px_30px_rgba(0,0,0,0.25)]"
            >
              {t('cta_secondary')}
            </a>
            <a
