      ...
      <div className="space-y-4">
        ...
        <div className="flex items-center gap-2">
          <input
            ...
            value={fullUrl}
            readOnly
            className="flex-1 px-4 py-2 bg-background border border-border rounded-lg text-sm text-cardText truncate"
          />
          <button
        ...
        <div className="flex justify-center gap-4">
          ...
          {supportsNativeShare && (
            ...
            >
              ...
              <span className="text-xs text-textSecondary">Share</span>
            </button>
          )}
          ...
          >
            ...
            <span className="text-xs text-textSecondary">Facebook</span>
          </button>
          ...
          >
            ...
            <span className="text-xs text-textSecondary">KakaoTalk</span>
          </button>
        </div>
      </div>
    </Modal>
