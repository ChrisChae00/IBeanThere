    ...
    <div className="fixed bottom-20 left-4 right-4 z-50 md:left-auto md:right-8 md:max-w-md">
      ...
      >
        <div className="bg-surface border border-border rounded-2xl shadow-2xl overflow-hidden">
          {/* Header with icon */}
          <div className="bg-linear-to-r from-primary to-secondary p-4">
            ...
            <div className="flex space-x-3">
              ...
              <button
                ...
                className="
                  ...
                  transition-all duration-200
                  focus:outline-hidden focus:ring-2 focus:ring-border focus:ring-offset-2
                "
              >
                Not now
              </button>
          ...
          {/* Progress bar */}
          <div className="h-1 bg-(--color-surface-2) overflow-hidden">
            <div
