    ...
    <div className={`${className}`}>
      ...
      {images.length > 1 && onViewAllClick && (
        <button
          ...
          className="mt-3 w-full py-2.5 px-4 text-sm font-medium text-text bg-surface hover:bg-surface-hover border border-border rounded-lg transition-colors flex items-center justify-center gap-2"
        >
